...
InstallPreRequisites(){
	#
	apt-get update
	apt-get install -y docker docker.io build-essential g++ avahi-daemon avahi-utils libsodium23 libzip5 libedit2 libxslt1.1 nmap curl jq wget git unzip sqlite3 php-dev
